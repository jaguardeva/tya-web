...
export default function HomePage() {
  return (
    <main className="w-full  text-slate-900">
      <section className="w-full  max-w-[1240px]  mx-auto grid md:grid-cols-2 px-4">
        <div className="w-full mt-16 sm:mt-24 lg:mt-[100px] flex flex-col gap-3 md:gap-5">
          ...
          <Link
            href="/about"
            className="mt-6 flex justify-center items-center w-[40%]  md:w-[30%] py-3 px-5 text-md md:text-xl font-semibold rounded-lg bg-purple-600 hover:bg-purple-700 text-white transition-all ease-in-out duration-150"
          >
            About Me
          </Link>
        </div>
